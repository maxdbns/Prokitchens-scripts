#!/usr/bin/env python3
"""
Déclenche le re-validation Vercel /api/cron/revalidate-google pour corriger
les sites web et noms faiblement appariés sur les leads existants.
"""
import os
import sys
...
def main():
    ...
    url = f"{site_url}/api/cron/revalidate-google"
