"""
Enrichissement INPI — Tous NAF cibles (56.10C, 56.21Z), toutes zones.
Tourne en tâche de fond, s'arrête à 9 500 requêtes (marge sur quota 10K/jour).
"""
...
REQUEST_DELAY = 0.35
BATCH_SIZE = 1000
LOG_FILE = "/zpool/one/maxime.debaugnies/logs/inpi_enrich_all.log"
...
def main():
    log("=" * 60)
    log("Démarrage enrichissement INPI — 56.10C + 56.21Z, toutes zones")
    log("=" * 60)
